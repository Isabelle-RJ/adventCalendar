...
function btnContainer(onDelete: ((slug: string) => void) | undefined, slug: string | undefined) {
  if(slug) {
    return (
...
export default function Calendar({ title, image, slug, onDelete, onUpdate, children, height='h-full', width='w-full' }: CalendarProps) {
